...
- statements: `insert:batchCreate`, `insert:create`, `select:getById`, `update:update`, `select:findBy`, `select:countOf`
- tables: `id`
...
- statements: `select:findPurchasePriceBy`, `select:findComponentPriceBy`, `select:findCompetitorPriceBy`, `select:queryProjectManagement`, `select:findStationPlanConfigs`, `select:findUseOrderBySkuAndStation`, `select:findStationIdsByRegion`, `select:findComponentSwitchBy`
- tables: `green_energy_light_station`, `light_project_management`, `light_report_competitor_price`, `light_report_component_price`, `light_report_component_switch`, `light_report_purchase_price`, `light_station_plan_config`, `light_use_order`
...
- statements: `select:queryCityPowerSummary`, `select:queryRegionPowerSummary`, `select:queryCityFullLoadHours`
- tables: `green_energy_light_station`, `green_energy_light_station_elec_day_report_new`
