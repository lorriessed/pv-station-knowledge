...
- 文件: `rrsjk-hds-web/src/main/java/com/rrsjk/hds/controller/light/RentSuspendApplicationController.java`
- @RequestMapping("/rentSuspendApplication")
- @GetMapping("list.do")
- @GetMapping("doExport.do")
- @PostMapping("firstAuditPass")
- @PostMapping("firstAuditReject")
- @PostMapping("finalAuditPass")
- @PostMapping("finalAuditReject")
- @PostMapping("applyRecover")
- @PostMapping("recoverAuditPass")
- @PostMapping("recoverAuditReject")
...
## HaierIdmLoginController
- 文件: `rrsjk-admin-auth-server/src/main/java/com/rrsjk/adminauthserver/haier/HaierIdmLoginController.java`
- @GetMapping(value = "/login", params = "provider=haier")
- @GetMapping(value = "/login", params = "provider=haier-callback")

## LoginController
- 文件: `rrsjk-admin-auth-server/src/main/java/com/rrsjk/adminauthserver/controller/LoginController.java`
- @GetMapping("/login")
- @GetMapping("/")

## AppPasswordTokenController
- 文件: `rrsjk-admin-auth-server/src/main/java/com/rrsjk/adminauthserver/controller/AppPasswordTokenController.java`
...
## ElectricityPriceDataReportController
- 文件: `vpp-api-gpower/vpp-gpower-biz/src/main/java/com/nahui/energy/controller/ElectricityPriceDataReportController.java`
- @RequestMapping("/electricityPriceDataReport")
- @GetMapping("/nodeHourlyAvg/page")
- @GetMapping("/nodeHourlyAvg/export")
- @GetMapping("/spotHourlyAvg/page")
- @GetMapping("/spotHourlyAvg/export")
...
- @PostMapping("/{id}/sync-fap-status")
...
- @PostMapping("/batch-audit-ok")
- @PostMapping("/rework-files/import")
- @PostMapping("/pull-up-status")
...
- @PostMapping("/{paymentReceiptCode}/fap-record")
...
- @GetMapping
- @GetMapping("/{subCenterCode}")
- @GetMapping("/{subCenterCode}/users")
- @GetMapping("/selectable-users")
- @PostMapping("/{subCenterCode}/users")
- @PostMapping("/{subCenterCode}/users/remove")
...
## ApiExceptionHandler
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/config/ApiExceptionHandler.java`
- 未扫描到显式 Mapping 注解
...
- @GetMapping("/supplier")
- @GetMapping("/pay-banks")
- @GetMapping("/contract-no")
- @GetMapping("/purchase-options")
- @PostMapping("/bill-pdf")
- @PostMapping(value = "/bill-files", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @PostMapping
- @PutMapping("/{id}")
- @PostMapping("/prepay")
- @PutMapping("/{id}/prepay")
- @GetMapping("/invoice-options")
- @PostMapping("/{id}/invoice-check")
...
- @GetMapping("/contracts/{contractNo}/signed-url")
- @GetMapping("/{id}/regions")
- @PostMapping("/regions/{zoneId}/audit")
- @GetMapping("/{id}/business-models")
- @PostMapping("/business-models/{modelId}/audit")
...
- @PutMapping("/{id}")
- @PostMapping("/{id}/enable")
- @PostMapping("/{id}/enable-third-party")
- @PostMapping("/{id}/disable")
- @GetMapping("/export")
...
- @GetMapping("/{purchaseOrderNo}/confirm-detail")
- @GetMapping("/stores/{id}")
- @PostMapping("/relations")
- @PostMapping("/{purchaseOrderNo}/confirm")
...
## WarningStationDetailController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/datadashboard/controller/WarningStationDetailController.java`
- @RequestMapping({
- @GetMapping
- @GetMapping("/export")
...
- @GetMapping("/nodes")
- @GetMapping("/project")
- @GetMapping("/attachment-templates")
- @GetMapping("/{id}")
- @PostMapping
- @PutMapping("/{id}")
- @PostMapping("/{id}/audit")
...
- @PostMapping("/{id}/audit")
- @GetMapping("/template")
- @PostMapping(value = "/parse-template", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @GetMapping("/{storeId}")
- @PostMapping("/addresses/{zoneId}/enable")
- @PostMapping("/addresses/{zoneId}/disable")
- @PostMapping("/addresses/{zoneId}")
- @GetMapping("/addresses/{zoneId}/logs")
...
- @GetMapping("/service-providers")
- @GetMapping("/stores")
- @GetMapping("/stores/{storeId}/sub-stores")
- @GetMapping("/stores/{storeId}/addresses")
- @GetMapping("/stores/{storeId}")
- @GetMapping("/sub-stores/{id}")
- @GetMapping("/addresses/{addressId}")
- @GetMapping("/check-30-days")
...
- @GetMapping("/{id}")
- @GetMapping("/stores/{id}")
- @PostMapping("/{id}/sub-center-audit")
- @PostMapping("/{id}/return")
- @PostMapping("/{id}/make-confirm")
...
- @PostMapping("/make-stock/preview")
- @PostMapping("/make-stock")
- @GetMapping("/direct-stock/options")
- @PostMapping("/direct-stock")
- @GetMapping("/service-providers/search")
- @GetMapping("/service-providers/{id}")
- @GetMapping("/service-providers/{id}/deposit")
- @GetMapping("/stores/main")
- @GetMapping("/stores/transit")
- @GetMapping("/stores/third-party")
- @GetMapping("/stores/{id}")
- @GetMapping("/stores/{storeId}/addresses")
- @GetMapping("/addresses/{addressId}")
- @GetMapping("/auclon-stores")
- @GetMapping("/auclon-stores/{id}")
- @GetMapping("/sku-data")
...
- @GetMapping("/template")
- @PostMapping("/import")
- @PostMapping("/{preOrderId}/confirm")
- @PostMapping("/{preOrderId}/invalid")
- @GetMapping("/{preOrderId}/relations")
- @GetMapping("/{preOrderId}/relations/export")
...
## WarehouseStandardPlanController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/warehouse/controller/WarehouseStandardPlanController.java`
- @RequestMapping("/api/admin/warehouse/standard-plans")
- @GetMapping
- @GetMapping("/{id}")
- @PostMapping
...
- @PostMapping(value = "/diagrams/upload", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @PostMapping("/audit")
- @PutMapping("/{id}")
- @PostMapping(value = "/apply-order-files", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @PostMapping("/{purchaseOrderId}/audit")
- @PostMapping("/cancel")
- @GetMapping("/{purchaseOrderId}/pre-orders")
...
- @GetMapping("/{id}")
- @GetMapping("/{id}/details")
- @GetMapping("/{id}/analysis-details")
- @GetMapping("/details/{detailId}/analysis")
- @PostMapping("/{id}/details")
- @PostMapping("/details/{detailId}/analysis")
- @PostMapping("/{id}/sub-center-audit")
- @PostMapping("/{id}/close-loop")
- @PostMapping("/{id}/supply-chain-audit")
- @DeleteMapping("/{id}")
- @GetMapping("/not-complete-stations")
- @PostMapping(value = "/files", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @GetMapping("/export")
...
- @PostMapping
- @PutMapping("/{packageNo}")
- @PostMapping("/{packageNo}/disable")
- @PostMapping("/{packageNo}/enable")
- @GetMapping("/sku-data")
- @PostMapping("/import")
...
- @GetMapping("/{id}")
- @GetMapping("/{id}/sns")
- @GetMapping("/{id}/sns/export")
- @GetMapping("/options")
- @GetMapping("/service-providers/{spId}/stores")
- @GetMapping("/stores/{storeId}/sub-stores")
- @GetMapping("/stores/{storeId}/addresses")
- @GetMapping("/stores/{storeId}")
- @GetMapping("/sub-stores/{id}")
...
- @GetMapping("/skus/{sku}")
- @PostMapping
- @PostMapping("/{id}/recommit-operation")
- @PostMapping("/{id}/cancel")
- @PostMapping("/{id}/sign-audit")
- @PostMapping("/{id}/operation-audit")
- @PostMapping("/{id}/supply-chain-audit")
- @PostMapping("/{id}/confirm-sns")
...
- @PostMapping("/{id}/supply-chain-audit")
- @GetMapping("/direct-stock/options")
- @GetMapping("/material-packages/{packageNo}")
- @GetMapping("/service-providers/{spId}/deposit")
- @GetMapping("/service-providers/{spId}/regions/{regionId}/store")
- @GetMapping("/stores/{id}")
- @PostMapping("/direct-stock")
...
- @GetMapping("/{changeId}/last-reject-reason")
- @PutMapping("/{changeId}/approve")
- @PutMapping("/{changeId}/asset-approve")
- @PutMapping("/{changeId}/acceptance-approve")
...
## LightStationTransferOrderController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/station/controller/LightStationTransferOrderController.java`
- @RequestMapping("/api/admin/station/station-transfer-orders")
- @GetMapping
- @GetMapping("/export")
...
- @GetMapping("/contract-history-url")
- @GetMapping("/{recordId}/sign-logs")
- @GetMapping("/{recordId}/operate-logs")
- @PutMapping("/{recordId}/revoke")
- @PutMapping("/{recordId}/restore")
...
- @GetMapping("/import-template")
- @PostMapping(value = "/import", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @PostMapping("/confirm-batch-audit")
- @PostMapping("/marketing-batch-audit")
- @PostMapping("/asset-batch-audit")
- @GetMapping("/{id}/detail")
...
- @GetMapping("/export")
- @GetMapping("/project-company-options")
- @PostMapping("/{id}/push-user-info")
- @PostMapping("/{id}/query-user-sign")
...
- @GetMapping("/technical-acceptances/{stationId}/detail")
- @GetMapping("/business-acceptances/{stationId}/detail")
- @GetMapping("/plan-audits/export")
- @GetMapping("/plan-audits/{stationId}/detail")
- @GetMapping("/plan-audits/{stationId}/last-reject-reason")
- @GetMapping("/plan-audits/{stationId}/operate-logs")
- @GetMapping("/plan-audits/auditors")
- @PostMapping("/plan-audits/redispatch")
- @GetMapping("/branch-stations")
- @GetMapping("/branch-stations/export")
- @GetMapping("/branch-stations/{stationId}/detail")
- @GetMapping("/branch-stations/{stationId}/electric-number/related")
- @GetMapping("/branch-stations/electric-number/station-file-info")
- @PostMapping("/branch-stations/{stationId}/electric-number/edit")
- @PostMapping("/branch-stations/{stationId}/electric-number/change")
- @GetMapping("/{stationId}/final-audit-policy")
- @PutMapping("/{stationId}/final-audit")
- @GetMapping({"/{stationId}", "/{stationId}/detail"})
- @GetMapping("/{stationId}/acceptance-report")
- @GetMapping("/branch-stations/{stationId}/initial-audit-inverter-options")
- @PutMapping("/branch-stations/{stationId}/initial-audit")
- @GetMapping("/branch-stations/{stationId}/first-audit-policy")
- @PutMapping("/branch-stations/{stationId}/first-audit")
- @GetMapping("/plan-audits/{stationId}/inverter-options")
- @GetMapping("/{stationId}/plan-inverters")
- @GetMapping("/{stationId}/inverters")
- @PutMapping("/{stationId}/inverters")
- @PostMapping("/{stationId}/change-inverter")
- @PostMapping("/{stationId}/wait-order-reject")
- @PostMapping("/{stationId}/contract/sign")
- @GetMapping("/export")
- @GetMapping("/bank-export")
- @GetMapping("/branch-stations/bank-export")
- @GetMapping("/files/download")
- @GetMapping("/files/preview")
...
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/mobile/auth/MobileAuthController.java`
- @RequestMapping("/api/mobile/auth")
- @GetMapping("/current-user")
- @PostMapping("/logout")

## TokenRefreshController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/mobile/auth/TokenRefreshController.java`
- @RequestMapping("/api/mobile/auth")
- @PostMapping("/token-refresh")

## MobileSnapshotController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/mobile/permission/MobileSnapshotController.java`
...
- @PostMapping("/{id}/project-push")
- @PostMapping("/{stationId}/contract-status/sync")
- @PostMapping("/{stationId}/cancel-lease")
- @PostMapping("/{stationId}/return-income")
- @PostMapping("/{stationId}/repush-return-income")
- @PostMapping("/{stationId}/return-finish")
- @PostMapping("/{stationId}/repush-follow-close")
- @PostMapping("/{id}/prj-sign-push")
...
- @GetMapping("/{id}")
- @GetMapping("/{id}/logs")
- @PostMapping("/{id}/leader-audit")
- @PostMapping("/{id}/xiaowei-audit")
- @PostMapping("/batch-audit")
- @PutMapping("/{id}")
- @PutMapping("/{id}/enable")
- @DeleteMapping("/{id}")
...
- @PostMapping("/{id}/enable")
- @PostMapping("/{id}/disable")
- @PostMapping("/areas/{id}/enable")
- @PostMapping("/areas/{id}/disable")
- @PostMapping("/{id}/delete")
- @GetMapping("/export")
- @GetMapping("/import-template")
- @PostMapping(value = "/import", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @GetMapping("/export")
- @GetMapping("/import-funder-template")
- @PostMapping(value = "/import-funder", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @GetMapping("/options/provinces")
- @GetMapping("/options/regions")
- @GetMapping("/options/banks")
- @GetMapping("/options/bank-provinces")
- @GetMapping("/options/bank-cities")
- @GetMapping("/options/bank-regions")
- @GetMapping("/options/house-banks")
...
- @GetMapping("/tax-classification")
- @GetMapping("/enable-items")
- @GetMapping("/cross-regional-tax")
- @PostMapping
- @PutMapping("/{id}")
- @DeleteMapping("/{id}")
- @GetMapping("/{id}")
...
- @GetMapping("/regions/provinces")
- @GetMapping("/regions")
- @GetMapping("/funnels/{funnelCode}")
- @GetMapping("/investors/by-name")
- @PostMapping("/project-set")
- @PutMapping("/project-set/{id}")
- @PostMapping("/project-vote")
- @PutMapping("/project-vote/{id}")
- @PostMapping(value = "/project-set/upload-file", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @PostMapping(value = "/project-vote/upload-file", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @GetMapping("/{id}/pre-track")
- @GetMapping("/{id}/vote-track")
- @PostMapping("/{id}/contracts")
- @PostMapping(value = "/{id}/contracts/upload-file", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @PostMapping("/{id}/receipt-milestones")
- @PostMapping("/{id}/payment-milestones/gross-margin")
- @PostMapping("/{id}/payment-milestones")
- @PostMapping(value = "/{id}/payment-milestones/upload-file", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @GetMapping("/{id}")
- @PostMapping
- @PostMapping("/{id}/audit-one")
- @PostMapping("/{id}/audit-two")
- @PostMapping(value = "/upload-image", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @GetMapping("/origin/by-invoice-number")
- @GetMapping("/origin/by-batch")
- @GetMapping("/templates/{templateCode}")
- @GetMapping("/template")
- @PostMapping(value = "/import", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @GetMapping("/export")
- @PostMapping("/batch-finance-summary")
- @PostMapping("/batch-finance-audit")
- @PostMapping(value = "/upload-storage", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @PostMapping("/acknowledge-check")
- @PostMapping("/acknowledge")
- @PostMapping("/acknowledge-by-ids")
- @PostMapping("/confirm")
- @PostMapping("/confirm-income-to-sap")
- @PostMapping("/confirm-paid")
- @PostMapping("/delete")
- @PostMapping("/delete-by-batch")
- @PostMapping("/upload-file")
- @GetMapping("/by-batch-numbers")
- @PostMapping("/reject")
- @PostMapping("/check-batch-confirm-paid")
- @PostMapping("/fap-sum")
- @PostMapping("/fap-manual")
- @PostMapping("/fap-manual-old")
- @PostMapping("/check-elec-no-bound")
- @GetMapping("/export")
- @GetMapping("/template")
...
- @GetMapping("/options")
- @GetMapping("/export")
- @GetMapping("/import-pay-result/template")
- @PostMapping("/import-pay-result")
...
- @PostMapping("/chainlead-audit")
- @GetMapping("/export")

## RentTaxSummaryController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/rentmanagement/controller/RentTaxSummaryController.java`
- @RequestMapping("/api/admin/rent-management/rent-tax-summaries")
- @GetMapping
- @GetMapping("/detail")
- @PostMapping("/confirm")
- @GetMapping("/export")
...
## RentTaxRecordController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/rentmanagement/controller/RentTaxRecordController.java`
- @RequestMapping("/api/admin/rent-management/rent-tax-records")
- @GetMapping
- @GetMapping("/detail")
- @GetMapping("/export")
...
- @PostMapping(value = "/import-visit", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
- @PostMapping("/upload-image")
- @PostMapping("/change")
...
- @PostMapping("/import")
- @GetMapping("/export")
- @GetMapping("/{id}/resync-files")
- @PostMapping("/{id}/resync")
- @PutMapping("/{id}/all-file-sync")
...
## FapPaymentController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/receiptmanagement/controller/FapPaymentController.java`
- @RequestMapping("/api/admin/receipt-management/fap-payments")
- @GetMapping
- @GetMapping("/options")
...
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/serviceprovidermanagement/controller/ServiceRegionController.java`
- @RequestMapping("/api/admin/service-provider-management/service-regions")
- @GetMapping
- @PostMapping("/{id}/audit")
- @GetMapping("/{id}/streets")
- @PostMapping("/{id}/streets")
- @GetMapping("/contracts/master")
- @GetMapping("/{id}/contract")
- @GetMapping("/options/provinces")
- @GetMapping("/options/regions")
- @GetMapping("/options/sub-centers")
- @GetMapping("/export")
...
## ServiceProvinceController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/serviceprovidermanagement/controller/ServiceProvinceController.java`
- @RequestMapping("/api/admin/service-provider-management/service-provinces")
- @GetMapping
- @GetMapping("/{id}/logs")
- @PostMapping("/{id}/audit")
- @GetMapping("/options/provinces")
...
- @PutMapping("/{id}")
- @GetMapping("/export")
- @GetMapping("/application/{spWaId}/export")
...
## BranchServiceProviderController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/serviceprovidermanagement/controller/BranchServiceProviderController.java`
- @RequestMapping({
- @GetMapping
- @GetMapping("/{id}/targets")
- @GetMapping("/{id}/limit")
- @GetMapping("/contracts/{contractNo}")
- @GetMapping("/{id}/grid-award-agreement")
- @PostMapping("/{id}/grid-award-agreement")
- @PostMapping("/{id}/audit/{stage}")
- @GetMapping("/options/provinces")
- @GetMapping("/options/regions")
- @GetMapping("/{id}/contract-records")
- @PostMapping("/{id}/mode")
- @PostMapping("/{id}/new-master")
- @GetMapping("/{id}/new-master")
- @PostMapping("/new-master/batch")
- @PostMapping("/{id}/freeze-document-entry")
- @PostMapping("/{id}/unfreeze-document-entry")
- @PostMapping("/{id}/refund-deposit")
- @PostMapping("/month-scale")
- @GetMapping("/export")
...
- @GetMapping("/{id}")
- @PostMapping("/{id}/audit")
- @PostMapping("/{id}/clear-sum")
- @PostMapping("/{id}/terminate")
- @GetMapping("/export")
- @GetMapping("/{id}/unsettled-incentives/export")
...
- @GetMapping("/export")
- @GetMapping("/{id}")
- @GetMapping("/{id}/audit-context")
- @PostMapping("/{id}/audit")
- @PostMapping("/{id}/cancel")
- @GetMapping("/{id}/pay-type-options")
- @PostMapping("/{id}/pay-type")
- @GetMapping("/service-providers")
- @GetMapping("/service-providers/{memberId}")
- @GetMapping("/sku-types")
- @GetMapping("/skus")
- @PostMapping("/force")
...
- @GetMapping("/{id}/audit-context")
- @PostMapping("/{id}/audit")
- @PostMapping("/{id}/force-sold-audit")
- @PostMapping("/{id}/final-force-sold-audit")
- @GetMapping("/force-add/echo")
- @GetMapping("/force-add/cost")
- @GetMapping("/{id}/force-edit")
- @PostMapping("/force")
- @GetMapping("/{id}/pay-type-options")
- @PostMapping("/{id}/pay-type")
- @PostMapping("/{id}/cancel")
- @PostMapping("/{id}/eam-file")
- @GetMapping("/mdm-customer")
- @PostMapping(value = "/upload-image", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
...
- @GetMapping("/{id}/audit-context")
- @PostMapping("/{id}/audit")
- @PostMapping("/{id}/force-finance-audit")
- @PostMapping("/{id}/confirm")
- @PostMapping("/{id}/fap-record")
- @PostMapping("/batch-confirm/summary")
- @PostMapping("/batch-confirm")
...
- @GetMapping("/{stationCode}/charts/day")
- @GetMapping("/{stationCode}/charts/month")
- @GetMapping("/{stationCode}/charts/year")
- @GetMapping("/{stationCode}/charts/total")
- @GetMapping("/{stationCode}/weather")
- @GetMapping("/{stationCode}/weather-forecast")
- @PostMapping("/update-first-three-power-at")
- @GetMapping("/export")
...
- @GetMapping("/power-check")
- @GetMapping("/{inveterSn}/detail")
- @GetMapping("/{inveterSn}/charts/day")
- @GetMapping("/{inveterSn}/charts/current-voltage")
- @GetMapping("/{inveterSn}/charts/month")
- @GetMapping("/{inveterSn}/charts/year")
- @GetMapping("/{inveterSn}/charts/total")
- @GetMapping("/weather")
- @GetMapping("/weather-forecast")
- @PostMapping("/unbind")

## AuthzAdminController
- 文件: `rrsjk-admin-bff/src/main/java/com/rrsjk/adminbff/authz/AuthzAdminController.java`
...
- @GetMapping("/users/{userId}/sub-centers")
- @PostMapping("/users/{userId}/sub-centers")
- @GetMapping("/users/{userId}/sub-centers/selectable")
- @PostMapping("/users/{userId}/sub-centers/remove")
...
## AuthController
- 文件: `rrsjk-admin-biff/src/main/java/com/rrsjk/adminbff/auth/AuthController.java`
- @RequestMapping("/api/app/auth")
- @GetMapping("/login")
- @GetMapping("/current-user")
- @PostMapping("/logout")
...
## AuthzController
- 文件: `rrsjk-admin-biff/src/main/java/com/rrsjk/adminbff/authz/AuthzController.java`
...
## RentTaxRecordController
- 文件: `rrsjk-admin-web/src/main/java/com/rrsjk/admin/controller/light/RentTaxRecordController.java`
- @RequestMapping("/rentTaxAmountRecord")
- @RequestMapping("list.html")
- @RequestMapping("summaryList.html")
- @RequestMapping("doList.do")
- @RequestMapping("doSummaryList.do")
- @RequestMapping("doRentTaxAmountRecordDetail.do")
- @RequestMapping(value = "/confirm.do", method = {RequestMethod.POST})
- @RequestMapping("doExport.do")
