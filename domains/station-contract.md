...
## 储能商城直连 (代码明确证明, 2026-01-19~2026-02-08 补漏第4期)
**来源**: `rrsjk-light-service` + `rrsjk-trade-service` (王金浩/yumiao王金浩)
**需求**: TAEI-2865 【零碳适家】储能商城直连

- 储能产品通过商城直连模式下单，不走传统电站创建流程
- 涉及订单服务与电站服务的接口对接

## 零碳适家 CBS 企业客户待审核提示 (代码明确证明, 2026-01-19~2026-02-08)
**来源**: `cbs-web` (姜传德/德, 魏秋阳)
**需求**: TAEI-2848 【零碳适家】CBS企业客户待审核提示

- CBS企业客户列表中增加待审核提示功能
- 企业客户状态搜索项新增 (TAEI-2851, 王希然)

## 零碳适家商户通消息通知 (代码明确证明, 2026-01-19~2026-02-08)
**来源**: `rrsjk-light-message-service` (包鑫/baoxin, 袁睿林)
**需求**: TAEI-2847 【零碳适家】商户通消息通知

- 商户通消息通知功能，支持消息推送和状态管理

## 零碳适家套餐管理页面新增导出 (代码明确证明, 2026-01-19~2026-02-08)
**来源**: `rrsjk-admin-web` (杨辉) + `rrsjk-light-service` (王金浩)
**需求**: TAEI-2828 【零碳适家】套餐管理页面新增导出

- 套餐管理页面增加导出功能，支持Excel导出

## 1PG0商城绿能工商业独立利润中心 (代码明确证明, 2026-01-19~2026-02-08)
**来源**: `rrsjk-trade-service` (包鑫/baoxin, 8+ commits, 2026-01-20~2026-02-04) + `rrsjk-finance-service`
**需求**: TAEI-2825 【商城】1PG0商城增加绿能工商业独立利润中心

- 1PG0订单记收入逻辑修改 (d27ab2e, 2026-01-20)
- 1PG0订单记收款逻辑修改 (3 commits, 2026-01-23)
- 发货记账逻辑修改 (0187568, 2026-01-20)
- GTMS返款修改 (2 commits, baoxin, 2026-01-20/26)
- 发票内部公司新增业务类型参数 (2 commits, 2026-02-03/04)

## 采购单发货支持中转仓 (代码明确证明, 2026-01-19~2026-02-08)
**来源**: `rrsjk-item-service` + `rrsjk-trade-service` (王斌/tn_wangb, 龙龙)
**需求**: TAEI-2824 【工商业】采购单发货支持中转仓发货

- 采购单发货流程增加中转仓发货选项
- 涉及订单状态和发货物流的变更

## 零碳E站统计逆变器套数 (代码明确证明, 2026-01-22)
**来源**: `rrsjk-trade-service` (马斌/mabin/龙龙, commits: 2725869~34c208c, 2026-01-22)
