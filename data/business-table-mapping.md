...
> 自动生成于 2026-06-29，基于 3,402+ 个 MyBatis Mapper XML 扫描
...
| 表名 | 库 | 说明 | Mapper引用数 |
|------|-----|------|-------------|
| `light_station` | rrsjk_light |  | 168 |
| `light_station_plan_config` | rrsjk_light |  | 33 |
| `light_station_audit` | rrsjk_light |  | 27 |
| `light_station_white_list` | rrsjk_light |  | 22 |
| `light_station_yuexiu` | rrsjk_light |  | 20 |
| `light_inveter_data` | rrsjk_light |  | 17 |
| `light_station_inverter` | rrsjk_light |  | 16 |
| `light_station_white_list_simple` | rrsjk_light |  | 15 |
| `light_station_contract_record` | rrsjk_light |  | 14 |
| `light_station_epc` | rrsjk_light |  | 13 |
| `light_station_elec_day_report_new` | rrsjk_light |  | 9 |
| `light_station_elec` | rrsjk_light |  | 8 |
| `light_station_elec_day_report` | rrsjk_light |  | 7 |
| `light_inveter` | rrsjk_light |  | 7 |
...
| `light_station_confirm_img` | rrsjk_light |  | 3 |
| `light_station_inverter_ocr` | rrsjk_light |  | 3 |
| `light_station_module_angle_ocr` | rrsjk_light |  | 3 |
...
| `light_station_plan_design` | rrsjk_light |  | 1 |
| `light_station_epc_file` | rrsjk_light |  | 1 |
...
| 表名 | 库 | 说明 | Mapper引用数 |
|------|-----|------|-------------|
| `cmb_leasing_station` | rrsjk_light |  | 33 |
| `boc_leasing_light_station` | rrsjk_light |  | 13 |

## 服务商体系

| 表名 | 库 | 说明 | Mapper引用数 |
|------|-----|------|-------------|
| `light_sub_sp` | rrsjk_light |  | 54 |
| `light_service_provider` | rrsjk_light |  | 31 |
| `light_sp_staff` | rrsjk_light |  | 24 |
| `light_sp_store` | rrsjk_light |  | 15 |
| `light_sp_authority_zone` | rrsjk_light |  | 12 |
| `light_sub_sp_region` | rrsjk_light |  | 6 |
...
| `light_sp_auclon_store` | rrsjk_light |  | 3 |
...
| `light_work_order` | rrsjk_light_operation |  | 11 |
| `light_operation_station` | rrsjk_light_operation |  | 11 |
...
| 表名 | 库 | 说明 | Mapper引用数 |
|------|-----|------|-------------|
| `light_purchase_order` | rrsjk_light |  | 15 |
| `cm_light_project` | rrsjk_light |  | 11 |
...
| `cm_construction_progress_audit` | rrsjk_light |  | 2 |
| `cm_light_project_sign_info` | rrsjk_light |  | 2 |
| `order_item_un_cash` | rrsjk_trade |  | 2 |
| `light_use_order` | rrsjk_light |  | 2 |
...
| `light_share_bill_record` | rrsjk_light |  | 6 |
...
| `light_project_electric_order_fap_record` | rrsjk_light |  | 1 |

## 报表

| 表名 | 库 | 说明 | Mapper引用数 |
|------|-----|------|-------------|
| `green_energy_light_station` |  |  | 10 |
| `green_energy_light_station_elec_day_report_new` |  |  | 8 |
| `green_energy_boc_leasing_light_station` |  |  | 5 |
| `green_energy_cmb_leasing_station` |  |  | 5 |
| `green_energy_light_station_white_list_simple` |  |  | 5 |
| `green_energy_light_city_elec_price` |  |  | 5 |
| `green_energy_report_light_station_chart_month` |  |  | 4 |
| `green_energy_inverter_current` |  |  | 4 |
...
| `green_energy_report_light_inverter_chart_day` |  |  | 3 |
| `green_energy_light_station_daily_current` |  |  | 3 |
| `green_energy_report_light_station_chart_total` |  |  | 2 |
| `green_energy_report_light_inverter_chart_total` |  |  | 2 |
| `green_energy_report_light_inverter_chart_year` |  |  | 2 |
| `green_energy_report_light_station_chart_year` |  |  | 2 |
| `green_energy_report_light_inverter_pac_chart_day` |  |  | 2 |
| `green_energy_report_light_inverter_chart_month` |  |  | 2 |
| `green_energy_report_light_station_chart_day` |  |  | 2 |
...
| `green_energy_light_station_white_list` |  |  | 1 |
| `green_energy_light_station_inverter` |  |  | 1 |
| `green_energy_light_station_plan_config` |  |  | 1 |
| `green_energy_light_use_order` |  |  | 1 |
| `green_energy_product_price` |  |  | 1 |
...
| `sj_workflow` |  |  | 18 |
| `sj_job` |  |  | 16 |
| `report_station_chart_month` |  |  | 15 |
| `energy_leased_station_asset_management` |  |  | 15 |
| `hrflc_sync_pv_info` |  |  | 14 |
| `user_message_relations` |  |  | 10 |
| `city` |  |  | 10 |
| `light_company_info` |  |  | 9 |
| `cd_dict_data` |  |  | 9 |
| `cnnc_leasing_light_station` |  |  | 9 |
| `yuexiu_leasing_light_station` |  |  | 9 |
| `sj_retry` |  |  | 8 |
| `sj_server_node` |  |  | 8 |
| `sp_tran_sn` |  |  | 8 |
| `vomproductdata` |  |  | 7 |
...
| `sj_retry_summary` |  |  | 7 |
| `sj_job_task` |  |  | 7 |
| `sj_retry_task_log_message` |  |  | 7 |
| `sj_job_executor` |  |  | 7 |
| `sj_job_summary` |  |  | 7 |
| `sj_job_log_message` |  |  | 7 |
| `sj_retry_dead_letter` |  |  | 7 |
| `gf_business_opportunity` |  |  | 7 |
| `cm_simple_project` | rrsjk_light |  | 7 |
...
| `sp_tran_sn_detail` |  |  | 6 |
| `light_project_management` | rrsjk_light |  | 5 |
| `zero_carbon_service_provider` |  |  | 5 |
| `light_enable_policy_area` |  |  | 5 |
...
| `t_product` |  |  | 2 |
| `sj_retry_scene_config` |  |  | 2 |
| `sj_workflow_task_batch` |  |  | 2 |
...
| `t_product_image` |  |  | 1 |
| `t_shipment_log` |  |  | 1 |
| `energy_app_overdue_inventory` |  |  | 1 |
| `light_grid_cert` |  |  | 1 |
| `light_audit_image_reject_record` |  |  | 1 |
| `gf_light_station_confirm_img` |  |  | 1 |
| `sp_station_status_snapshot` |  |  | 1 |
| `elec_warning_station` |  |  | 1 |
| `hot_news` |  |  | 1 |
...
| `admin_log_body_detail` |  |  | 1 |
| `admin_assistant_session` |  |  | 1 |
| `admin_oper_log` |  |  | 1 |
| `admin_login_log` |  |  | 1 |
| `admin_assistant_message` |  |  | 1 |
| `shop` |  |  | 1 |
| `expert_customer` |  |  | 1 |
...
| `light_log_off` |  |  | 1 |
| `member_energy` |  |  | 1 |
| `tou_electricity_price` |  |  | 1 |
| `electricity_price_of_coal` |  |  | 1 |
| `electricity_price_summary_diff_period` |  |  | 1 |
| `dev_forecast` |  |  | 1 |
| `i18n_message` |  |  | 1 |
| `lan_id` |  |  | 1 |
| `ngb_station_user` |  |  | 1 |
...
| `light_purchase_sales_purchase_order` | rrsjk_light |  | 1 |
| `activity_pic` |  |  | 1 |
| `activity` |  |  | 1 |
| `net_pay_log` |  |  | 1 |
| `benefit_consumer` |  |  | 1 |
...
| `cook_day` |  |  | 1 |
| `authz_permission` |  |  | 1 |
| `authz_user_permission` |  |  | 1 |
| `authz_user` |  |  | 1 |
| `authz_user_sub_center` |  |  | 1 |
| `authz_sub_center` |  |  | 1 |
| `authz_user_password` |  |  | 1 |
| `authz_role_permission` |  |  | 1 |
| `authz_menu` |  |  | 1 |
| `authz_user_role` |  |  | 1 |
| `authz_role` |  |  | 1 |
| `knowledge_user` |  |  | 1 |
...
| `light_report_competitor_price` |  |  | 1 |
| `light_report_purchase_price` |  |  | 1 |
| `light_report_component_switch` |  |  | 1 |
| `light_report_component_price` |  |  | 1 |
| `light_instant_grid_reward_policy` |  |  | 1 |
| `light_tech_auditor_operation_log` |  |  | 1 |
| `report_policy_forecast` |  |  | 1 |
| `dim_sap_split_node` |  |  | 1 |
| `dim_sap_revenue_cost_target` |  |  | 1 |
| `offline_old_count` |  |  | 1 |
| `elec_today_val` |  |  | 1 |
| `cond1_count` |  |  | 1 |
| `offline_today_count` |  |  | 1 |
| `base_stations` |  |  | 1 |
