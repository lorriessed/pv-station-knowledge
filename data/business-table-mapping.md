...
> 自动生成于 2026-07-02，基于 3,402+ 个 MyBatis Mapper XML 扫描
...
| 表名 | 库 | 说明 | Mapper引用数 |
|------|-----|------|-------------|
| `green_energy_light_station` |  |  | 11 |
| `green_energy_light_station_elec_day_report_new` |  |  | 8 |
| `green_energy_cmb_leasing_station` |  |  | 7 |
| `green_energy_energy_leased_station_asset_management` |  |  | 7 |
| `green_energy_boc_leasing_light_station` |  |  | 5 |
| `green_energy_light_station_white_list_simple` |  |  | 5 |
| `green_energy_hrflc_sync_pv_info` |  |  | 5 |
